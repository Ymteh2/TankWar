...
public class TankClient extends Frame {
    ...
    Wall w1 = new Wall(100,200,20,150,this),w2 = new Wall(300,150,300,20,this);
    ...
    public void paint(Graphics g) {
        ...
        if(tanks.size()<=0){
            for(int i = 0;i<Integer.parseInt(ProperterMgr.getProper("reProduceTankCount"));i++){
                tanks.add(new Tank(50+50*(i+1),50,false,Tank.Direction.D,this));
            }
        }
    ...
    public void launchFrame(){
        ...
        int initTankCount = Integer.parseInt(ProperterMgr.getProper("initTankCount"));//字符串转化为整数
